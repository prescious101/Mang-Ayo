...
import com.example.mangayo.model.AutoMechanicModel;
...
public class MechanicDetails extends AppCompatActivity {
    ...
    public void getMechanicDetails(){
        ...
        try {
            Url.getMechaniDetails +="?mechanic_id="+mechanic_id+"&userType=MECHANIC";
            URL url=new URL(Url.getMechaniDetails);
    ...
    public void bookMehanic(){
        ...
        try {
            Url.addBookingMechanic+="?user_id="+user_id+"&mechanic_id="+mechanic_id+"&service_id="
                +service_id+"&vehicle_id="+vehicle_id+"&latitude="+lat+"&longitude="+lng+"&booking_status="+booking_status;
            URL url=new URL( Url.addBookingMechanic);
            HttpURLConnection conn= (HttpURLConnection) url.openConnection();
            BufferedReader br=new BufferedReader(new InputStreamReader(conn.getInputStream()));
            String message=br.readLine();
