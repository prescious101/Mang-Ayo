...
import com.example.mangayo.fragments.MechanicBookingFragment;
import com.example.mangayo.fragments.MechanicHomepageFragment;
import com.example.mangayo.fragments.MechanicProfileFragment;
import com.example.mangayo.fragments.MechanicSchedulingFragment;
...
public class MechanicHomepage extends AppCompatActivity {
    ...
    MechanicHomepageFragment mechanicHomepageFragment = new MechanicHomepageFragment();
    MechanicProfileFragment mechanicProfileFragment = new MechanicProfileFragment();
    MechanicBookingFragment mechanicBookingFragment = new MechanicBookingFragment();
    MechanicSchedulingFragment mechanicSchedulingFragment = new MechanicSchedulingFragment();
