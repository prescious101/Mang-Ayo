<?php
	...
	$ok = mysqli_query($db, "INSERT INTO booking (service_id, mechanic_id, 
		vehicle_id, user_id, booking_status,longitude,latitude) 
			VALUES ('$service_id', '$mechanic_id', '$vehicle_id','$user_id','$booking_status','$longitude'
				,'$latitude') ");
